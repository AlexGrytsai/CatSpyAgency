...
class CatModelTest(TestCase):
    ...
    def test_cat_model_valid_breed(self, mock_get):
        ...
        cat = CatModel(
            name="SpyCat", breed="Siamese", experience=5, salary=1000
        )
    ...
    def test_cat_model_invalid_breed(self, mock_get):
        ...
        cat = CatModel(
            name="SpyCat", breed="Bengal", experience=5, salary=1000
        )
    ...
    def test_invalid_salary(self):
        cat = CatModel(
            name="SpyCat", breed="Siamese", experience=5, salary=-100
        )
    ...
    def test_unrealistic_experience(self):
        cat = CatModel(
            name="SpyCat", breed="Siamese", experience=100, salary=1000
        )
...
class TargetModelTest(TestCase):
    ...
    def test_target_notes(self):
        target = TargetModel.objects.create(
            name="Target2", country="Country2", notes="Important mission"
        )
...
class MissionModelTest(TestCase):
    def setUp(self):
        ...
        self.target1 = TargetModel.objects.create(
            name="Target1", country="Country1"
        )
        self.target2 = TargetModel.objects.create(
            name="Target2", country="Country2"
        )
